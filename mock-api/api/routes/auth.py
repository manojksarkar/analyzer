...
from ..schemas import SignInResponse, RefreshResponse, MessageResponse, MeResponse
...
@router.post("/signin", responses={200: {"model": SignInResponse}})
...
@router.post("/refresh", responses={200: {"model": RefreshResponse}})
...
@router.post("/signout", responses={200: {"model": MessageResponse}})
...
@router.get("/me", responses={200: {"model": MeResponse}})
def get_me(current_user: User = Depends(get_current_user)):
    return {"user": _user_to_dict(current_user)}


@router.patch("/me", responses={200: {"model": MeResponse}})
def update_me(
