...
def _seed_jobs() -> dict[str, AnalysisJob]:
    ...
    jobs = [
        AnalysisJob(
            ...
            branch="main", version_tag="v1.2.0",
        ),
        AnalysisJob(
            ...
            branch="develop", version_tag="v2.0.0",
        ),
    ]
...
def _seed_documents() -> dict[str, Document]:
    ...
    entries = [
        ...
        # SWE.3 detailed designs map to the committed render fixtures (Full/Access/Diag).
        ("doc1",  "ver3", "p1", "SWE.3", "Full",                  "All components · Detailed Design", "Layer1", "Full",   "in_review"),
        ("doc2",  "ver3", "p1", "SWE.3", "Access",                "Access component · Detailed Design", "Layer1", "Access", "in_review"),
        ...
        ("doc6",  "ver3", "p1", "SWE.3", "Diag",                  "Diag component · Detailed Design", "Layer1", "Diag",   "unchanged"),
        ("doc7",  "ver2", "p1", "SWE.3", "Full",                  "All components · Detailed Design", "Layer1", "Full",   "approved"),
