  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-8 h-8 bg-secondary rounded-lg flex items-center justify-center flex-shrink-0">
            <span className="material-symbols-outlined sym-fill text-white" style={{ fontSize: 18 }} aria-hidden>
              account_tree
            </span>
          </div>
          {!collapsed && (
            <div className="min-w-0 overflow-hidden text-left">
              <h1
                className="text-primary font-bold tracking-tight whitespace-nowrap"
                style={{ fontFamily: 'Inter', fontSize: 15, lineHeight: 1.2 }}
              >
                [PRODUCT NAME]
              </h1>
              <p
                className="text-on-surface-variant uppercase whitespace-nowrap mt-0.5"
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-2" aria-label="Project sections">
        ...
        >
          <span className="material-symbols-outlined flex-shrink-0" style={{ fontSize: 18 }} aria-hidden>arrow_back</span>
          {!collapsed && (
            <span style={{ fontFamily: "'JetBrains Mono'", fontSize: 11, fontWeight: 500 }}>All Projects</span>
          )}
        </button>
        ...
        {!collapsed && project && (
          <p
            className="px-3 pb-1.5 text-on-surface-variant uppercase truncate"
            style={{ fontSize: 10, fontFamily: "'JetBrains Mono'", fontWeight: 600, letterSpacing: '0.09em' }}
          >
            {project.name}
          </p>
        )}
        ...
        <div className="space-y-0.5">
          {NAV_ITEMS.map(({ label, icon, to }) => (
            ...
            >
              <span className="material-symbols-outlined flex-shrink-0" style={{ fontSize: 20 }} aria-hidden>
                {icon}
              </span>
              {!collapsed && (
                <span style={{ fontFamily: "'JetBrains Mono'", fontSize: 12, fontWeight: 500, letterSpacing: '0.02em' }}>
                  {label}
                </span>
              )}
            </NavLink>
      ...
      <div className="px-2 pt-2 border-t border-outline-variant flex-shrink-0">
        ...
        >
          <span className="material-symbols-outlined flex-shrink-0" style={{ fontSize: 18 }} aria-hidden>settings</span>
          {!collapsed && (
            <span style={{ fontFamily: "'JetBrains Mono'", fontSize: 12, fontWeight: 500 }}>Settings</span>
          )}
        </button>
      </div>
      ...
      <div className="px-2 pb-3 pt-1 flex-shrink-0">
        ...
        >
          <div className="w-9 h-9 rounded-full bg-secondary-container flex items-center justify-center flex-shrink-0">
            <span
              className="text-on-secondary-container font-bold text-sm"
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              <p
                className="text-on-surface truncate leading-tight"
