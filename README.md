...
- **Specs** (engineering, per doc-type) — [SWE3_SPEC](docs/spec/SWE3_SPEC.md) · [SWE4_SPEC](docs/spec/SWE4_SPEC.md) · [UT export](docs/spec/UT_EXPORT_SPEC.md) ([readiness](docs/spec/UT_EXPORT_READINESS.md)) · [test inventory](docs/spec/TEST_INVENTORY.md)
