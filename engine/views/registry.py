...
# PhaseRunner). SWE.4's exporter lands in a later task; the entry is wired now so
# the planner and --to-phase mapping know about it.
EXPORTER_REGISTRY = {
...
# run reproduces the SWE.3 document exactly. SWE.4 reads the model directly and
# needs only the testSpecs view.
DOC_TYPE_VIEWS = {
    DOC_TYPE_SWE3: None,
    DOC_TYPE_SWE4: ("testSpecs",),
}
